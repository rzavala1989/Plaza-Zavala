...
namespace HotelAppLibrary.Migrations
{
    ...
    [Migration("20240716042217_FinalForNow")]
    partial class FinalForNow
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelAppDataAccess.Models.RoomModel", b =>
                {
                    ...
                    b.Property<int?>("HotelModelHotelId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HotelAppDataAccess.Models.RoomModel", b =>
                {
                    b.HasOne("HotelAppLibrary.HotelModel", null)
                        .WithMany("Rooms")
                        .HasForeignKey("HotelModelHotelId");
